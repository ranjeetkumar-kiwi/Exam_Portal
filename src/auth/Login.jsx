  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        <h1 className="text-3xl font-semibold text-center text-blue-700 uppercase">Welcome Back !</h1>
        <h1 className="text-xl font-semibold text-center text-blue-700 uppercase">Sign In</h1>
