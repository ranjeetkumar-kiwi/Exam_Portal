      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <Link rel="noopener noreferrer" className="flex justify-center space-x-3 md:justify-start">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            ...
            <ul>
              <li>
                <Link rel="noopener noreferrer" className="hover:dark:text-violet-400">
                  About
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            ...
            <ul>
              <li>
                <Link rel="noopener noreferrer" className="hover:dark:text-violet-400" to="">
